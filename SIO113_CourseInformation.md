...
* Complete answers to any practice problem or homework assignment which are generated by ChatGPT are not considered "original work that is yours alone". You may use ChatGPT to debug you own code, and as a help resource (like you would a tutorial). You may also use ChatGPT to verify the correctness of your own code. If you do use ChatGPT in any capacity for a submission, please indicate this in your submission and provide the exact query you used.
